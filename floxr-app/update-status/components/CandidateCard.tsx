...
const CandidateCard: React.FC<CandidateCardProps> = ({ candidate }) => {
  return (
    <div className="bg-white dark:bg-[#181c24] rounded-xl border border-slate-200 dark:border-[#282e39] p-6 shadow-sm">
      <div className="flex flex-col items-center">
        <div className="relative w-32 h-32 mb-4">
          <img
            alt={candidate.name}
            className="w-full h-full rounded-full object-cover ring-4 ring-slate-100 dark:ring-[#282e39]"
            src={candidate.image}
          />
          <div className="absolute bottom-1 right-1 bg-green-500 border-4 border-white dark:border-[#181c24] w-6 h-6 rounded-full"></div>
        </div>
        ...
        <div className="w-full h-px bg-slate-100 dark:bg-[#282e39] my-6"></div>
        ...
        <div className="w-full mt-6">
          ...
          <div className="w-full bg-slate-100 dark:bg-[#282e39] rounded-full h-2">
            <div
